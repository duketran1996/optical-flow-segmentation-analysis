...
class Track:
    ...
    def smooth_trajectory(self, frame_difference: int):
        ...
        for curr_frame in range(0,traj_length):
            ...
            if (traj_length - 1 ) - curr_frame < frame_difference:
                # print("frame difference longer than trajectory:")
                frame_difference = len(self.history) - curr_frame - 1
                # print("new frame dist:",frame_difference)
